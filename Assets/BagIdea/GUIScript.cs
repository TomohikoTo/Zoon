...
namespace zoon {
	...
	public class GUIScript : MonoBehaviour, IGUIController
	{
		...
		public void FloorRotate(float x, float y, float z) {
			floor.Rotate (x, y, z);
		}

		public void GolemRotate(float x, float y, float z) {
			golem.Rotate(x,y,z);
		}
